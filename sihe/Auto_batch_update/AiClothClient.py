...
class AiClothClient:
    DEFAULT_COOKIE_PATH = 'XXX-cookie.txt'
    DEFAULT_BASE_URL = 'https://XXX.YYY.com'
    DEV_SERVER_BASE_URL = 'https://XXX-dev.YYY.com'
    ...
    def get_alert_list(self):
        headers = {
            ...
            "referer": "https://XXX.YYY.com/detectionMachine/list",
